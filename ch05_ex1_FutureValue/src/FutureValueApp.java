...
public class FutureValueApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			printFormattedResult(monthlyInvestment, interestRate, years, futureValue);
	...
	private static void printFormattedResult(double monthlyInvestment, double interestRate, int years,
			double futureValue) {
